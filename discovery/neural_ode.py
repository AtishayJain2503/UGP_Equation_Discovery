...
class NeuralODE:
    ...
    def fit(self, X, Xdot, t):
        ...
        self.model = NeuralODEModel(self.input_dim, self.state_dim).to(self.device)
    ...
    def equations(self):
        ...
        return f"Neural ODE: MLP [{self.input_dim}->64->64->{self.state_dim}], 500 epochs, final_loss={loss_str}"